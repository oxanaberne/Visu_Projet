...
def attackers_perf(players_data):
    attackers_data = filter_players_by_position(players_data, attackers, False)
...
def mid_perf(players_data):
    midfielders_data = filter_players_by_position(players_data, midfielders, False)
    transformed_data = process_mid_perf(midfielders_data)
    return draw_graph_mid(transformed_data)

def defenders_perf(players_data):
    defenders_data = filter_players_by_position(players_data, defenders, False)
